...
<body>
    ...
    <p>Method overriding allows a child class to provide a different implementation of a method that is already defined
        in its parent class. The child's version replaces the parent's version when called on a child object.</p>

    <!-- Example 1 -->
    <h2>Overriding __toString()</h2>
    <p>A child class can override the parent's <code>__toString()</code> method to provide a different string
        representation.</p>
...
echo $savings;</code></pre>
    ...
    <p>When overriding a method, you can still call the parent's version using <code>parent::methodName()</code>. This
        is useful when you want to extend the parent's behaviour rather than replace it entirely.</p>
...
echo "Transactions: " . $current->getTransactionCount();</code></pre>
    ...
    <p>The <code>CurrentAccount</code> class in our v2 folder tracks transactions and charges fees for transactions
        beyond the free limit.</p>
...
echo "(Fee: 2 transactions x &euro;1.50 = &euro;3.00)";</code></pre>
    ...
    <!-- Example 4 -->
    <h2>Polymorphism</h2>
    <p>Because child classes share the same interface as the parent, we can treat different account types uniformly.
        This is called polymorphism.</p>
...
foreach ($accounts as $account) {
    ...
    <div class="output">
        ...
        $accounts = [
            new BankAccount("1111111111", "Alice", 100.00),
            new Undergrad("2222222222", "Bob", 200.00, 0.05),
            new CurrentAccount("3333333333", "Charlie", 300.00)
        ];
